 ...
 * @author hlc
 */
public class AsaigGenerator extends ContractGenerator {
	
	public AsaigGenerator(AID starterAgent, jade.util.leap.List props) {
