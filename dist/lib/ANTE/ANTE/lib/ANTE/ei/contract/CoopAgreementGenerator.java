 ...
 * @author hlc
 */
public class CoopAgreementGenerator extends ContractGenerator {
	
	public CoopAgreementGenerator(AID starterAgent, jade.util.leap.List props) {
