...
public class AsaigPlusContextGenerator extends AbstractContextGenerator {
	
	public AsaigPlusContextGenerator(List contractualInfos) {
	...
	public Context generateContext() {
		...
		for(int i=0; i<contractualInfos.size(); i++) {
			...
			if(f.getName().equals("asaig-plus-data")) {
